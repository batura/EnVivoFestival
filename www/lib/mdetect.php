...
class uagent_info
{
   ...
   var $deviceWinPhone7bis = 'windows phone os 7.0';
   var $deviceWinPhone7bisbis = 'iemobile/7.0';
   ...
   //**************************
   // Detect a mobile compatible w/ JQueryMobile
   function DetectJQueryMobile()
   {
   ...
   {
      if ( (stripos($this->useragent, $this->deviceWinPhone7) > -1) || (stripos($this->useragent, $this->deviceWinPhone7bis) > -1) || (stripos($this->useragent, $this->deviceWinPhone7bisbis) > -1) ) 
         return $this->true; 
      else
         return $this->false; 
   }
